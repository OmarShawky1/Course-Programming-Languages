...
class Piece 
  ...
  def initialize (point_array, board)
    @all_rotations = point_array #storing all possible rotations/shapes of the same tetris piece
    
    #choosing a random rotation out of all possible rotations
    @rotation_index = (0..(@all_rotations.size-1)).to_a.sample #sample is just java random() function. 
